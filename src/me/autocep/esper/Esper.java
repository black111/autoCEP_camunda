...
import me.autocep.esper.queries.MonitoringQueries;
...
public class Esper extends Thread {
    ...
    public Esper(AutoCEP main, String dataset, List<TimeSequence> rules) {
        this.rules = rules;
        this.main = main;
...
//                System.out.println("End of File Reached");
                ...
                AutoCEP.signal(main, false, false);
